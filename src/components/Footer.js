        ...
        <div className="footer-top">
          ...
          <div className="footer-brand">
            ...
            <div className="footer-contact-item">
              ...
              <a style={{ cursor: 'pointer', color: '#C9A84C' }} href="tel:+2349167327933">+234 9167327933</a>
            </div>
            <div className="footer-contact-item">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" width="16" height="16">
              ...
              <a style={{ cursor: 'pointer', color: '#C9A84C' }} href="mailto:contacto@awayhomehq.com">contact@awayhomehq.com</a>
            </div>
          </div>
